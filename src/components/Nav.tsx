...
import logoZk from "../assets/logo-zkk.png";

const links = [
  { to: "/", label: "Accueil" },
  { to: "/pourquoi-nous-rejoindre", label: "Pourquoi nous rejoindre" },
  { to: "/nos-opportunites", label: "Nos opportunités" },
  { to: "/processus-de-recrutement", label: "Processus de recrutement" },
];
  ...
  return (
    ...
    >
      ...
      {isMenuOpen ? (
        ...
        >
          <nav className="flex min-h-[calc(70vh-3rem)] flex-col">
